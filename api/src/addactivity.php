...
use FirebaseJWT\Key;
/** 
 * add a new activity  the database. 
 * @author Noorullah Niamatullah
 */
class AddActivity extends Endpoint
{   private $userid=32;
    ...
    protected function initialiseSQL() {   
      $sql = "INSERT INTO activity ( userID,activityCategory,activityName,date,time,duration,activityNotes)
              VALUES (:userID, :activityCategory, :activityName, :date, :time, :duration, :activityNotes)";
      $this->setSQL($sql);
      $this->setSQLParams(['userID'=>$this->userid ,'activityCategory'=> $_POST['activityCategory'],'activityName'=> $_POST['activityName'],'date'=> $_POST['date'],'time'=> $_POST['time'],'duration'=> $_POST['duration'],'activityNotes'=> $_POST['activityNotes']]);
    }
