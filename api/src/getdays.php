...
use FirebaseJWT\Key;
/** 
 *  get a list of activities for a given month 
 * @author Noorullah Niamatullah
 */
class Getdays extends Endpoint
{   private $userid=32;
    ...
    protected function initialiseSQL() {   
      $sql = "SELECT 
      activityCategory,activityName,date,time,duration,activityNotes,activityID
      FROM activity where userID=:userID and date between :start And :end ORDER BY activityID DESC";
      $this->setSQL($sql);
      $this->setSQLParams(['userID'=>$this->userid,'start'=>$_POST['start'],'end'=>$_POST['end']]);
    }
